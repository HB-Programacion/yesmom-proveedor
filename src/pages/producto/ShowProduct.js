        ...
        <>
                        ...
                        <div className="container-content">
                            <div className="flex-content-product">
                                ...
                                <div className="container-details"> 
                                    <section className="some-info-product">
                                        <h5>Conjunto Bebe 4 piezas</h5>
                                        <h6>Único - Baby plaza</h6>
                            ...
                            <div className="container-details">
                                <section className="all-info-producto">
                                    ...
                                    <h5>Puntos destacados del producto</h5>
                                    <ol>
            ...
            <style jsx>
                {`      
                        ...
                        .control-cantidad, .control-buttons p{
                            font-size:2.4rem;
                            color:#D3DEE3;
                            width:4rem;
                            height:4rem;
                        ...
                        .container-buttons,.container-actions{
                            margin: 3rem 2rem;
                        }
                        .container-buttons>div,.container-actions>div{
                            margin:1.5rem 0;
